...
<div class="alert alert-danger" role="alert">
	Il y a actuellement <b><?php echo $m->getNumberArticles(); ?></b> publié<?php if($m->getNumberArticles() > 1) {echo "s";} #Avec cette condition, on ajoute le 's' a 'publié' quand plusieurs articles sont visibles sur le blog ?> sur le blog !
</div>
